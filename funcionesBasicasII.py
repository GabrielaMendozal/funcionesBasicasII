...
#contenga solo los valores de la lista original que sean mayores que su segundo valor. Imprime cuántos 
#valores son y luego devuelve la lista nueva. Si la lista tiene menos de 2 elementos, has que la función devuelva False
...
def valoresMayoresSegundo (lista):
    if len (lista) < 2:
        return False
    nuevaLista = []
